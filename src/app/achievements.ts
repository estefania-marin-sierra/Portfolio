export const achievements_1 = [
  ...
  },
  {
    ...
    techFrench: ['Rapports et articles scientifiques', 'Appréciation critique de la littérature médicale', 'PON et des manuels de procédures', `Rapports pour l'évaluation de projet`, 'Demandes de subventions, protocoles éthiques et manuscrits pour publication']
  },
]
...
export const achievements_2 = [
  ...
  },
  {
    ...
    name: 'Software',
    tech: ['Office suite (MS Project, Excel, Word, etc)', 'Task management (Smarsheet, Asana, Jira, etc)', 'CRM (Salesforce, Hubspot)', 'SAP', 'Invision', 'Inshot'],
    nameFrench: 'Logiciel',
    techFrench: ['Office suite (MS Project, Excel, Word, etc)', 'Task management (Smarsheet, Asana, Jira, etc)', 'CRM (Salesforce, Hubspot)', 'SAP', 'Invision', 'Inshot']
  },
];
