...
export const Projects = [
  ...
  },
  {
    ...
    dialog: {
      ...
      tasks:[['Indication of a project health status', 'Auto-update of status based on the ratio of tasks marked overdue or at risk'], ['Automatic flagging of taskswith due date in less than 10 days', 'Automatic flagging of overdue tasks', 'Automatic flagging when tasks are set on hold'],
              ['Auto update of task status','Task status based on baseline plan', 'Task status based on percentage of completion reached'], ['Usage of latest comment feature to track historical comments', 'Update of main project plan with only comments provided in the last 10 days for easy assessment', 'Creation of automated report for latest comments'],
      ...
      images:['https://estefania-marin-sierra.github.io/Portfolio/assets/images/project_health.png','https://estefania-marin-sierra.github.io/Portfolio/assets/images/at_risk.png','https://estefania-marin-sierra.github.io/Portfolio/assets/images/at_risk.png',
